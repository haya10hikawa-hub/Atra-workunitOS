...
**Source audit:** P6-A0(docs/legacy/P6_A0_FABEL5_PHASE6_CROSS_LANE_AUDIT.md FINAL-3 = B-2、docs/legacy/P6_A0_FABEL5_PATCH_SEQUENCE_PLAN.md Wave 2 / U3)
...
- 変更してよいtrackedファイルは次の3件のみ:
  - docs/legacy/P6_FIX_002_EXPLICIT_HUMAN_GO.md(本書)
...
- migrations/・package.json・package-lock.json・.github/workflows/・UI・Electron・API routes・既存P6-A0監査文書・既存P6-I5実装文書・docs/legacy/ALPHA_EVIDENCE_LEDGER.md・docs/archive/v0/GRAPH_MODEL.mdを変更しない。
