...
**Source audit:** P6-A0(docs/legacy/P6_A0_FABEL5_PHASE6_CROSS_LANE_AUDIT.md FINAL-5 = B-4+B-5、docs/legacy/P6_A0_FABEL5_PATCH_SEQUENCE_PLAN.md Wave 0)
...
- 本パッチは **tests only** である。変更してよいtrackedファイルは次の3件のみ:
  - docs/legacy/P6_FIX_001_EXPLICIT_HUMAN_GO.md(本書)
