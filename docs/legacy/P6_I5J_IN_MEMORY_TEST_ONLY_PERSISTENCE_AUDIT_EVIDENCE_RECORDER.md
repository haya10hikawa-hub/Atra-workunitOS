...
- `docs/legacy/P6_I5J_EXPLICIT_HUMAN_GO.md` — durable human Go record.
- `docs/legacy/P6_I5J_IN_MEMORY_TEST_ONLY_PERSISTENCE_AUDIT_EVIDENCE_RECORDER.md` — this document.
