...
**Source audit:** P6-A0(docs/legacy/P6_A0_FABEL5_PHASE6_CROSS_LANE_AUDIT.md FINAL-1 = B-3 + D-1、docs/legacy/P6_A0_FABEL5_PATCH_SEQUENCE_PLAN.md Wave 3 / U1)
...
- migrations/・package.json・package-lock.json・.github/workflows/・UI・Electron・API routes・linkageモジュール・fixtures・harnesses・types.ts・constructors・既存P6-A0/P6-I5/P6-FIX-001..003文書・docs/legacy/ALPHA_EVIDENCE_LEDGER.md・docs/archive/v0/GRAPH_MODEL.md を変更しない。
