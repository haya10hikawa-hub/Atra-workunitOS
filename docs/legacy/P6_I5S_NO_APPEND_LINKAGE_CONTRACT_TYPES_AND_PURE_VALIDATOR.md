...
artifact, no `tests/fixtures/`, no `tests/harness/`, no `docs/legacy/ALPHA_EVIDENCE_LEDGER.md`, and no
...
- `docs/legacy/P6_I5S_EXPLICIT_HUMAN_GO.md` — durable human Go record, created before code.
- `docs/legacy/P6_I5S_NO_APPEND_LINKAGE_CONTRACT_TYPES_AND_PURE_VALIDATOR.md` — this document.
