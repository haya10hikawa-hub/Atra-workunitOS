...
**Source audit:** P6-A0(docs/legacy/P6_A0_FABEL5_PHASE6_CROSS_LANE_AUDIT.md FINAL-4 = B-1、docs/legacy/P6_A0_FABEL5_PATCH_SEQUENCE_PLAN.md Wave 2 / U4)
...
- **tests/harness only** — 変更してよいtrackedファイルは次の5件のみ:
  - docs/legacy/P6_FIX_003_EXPLICIT_HUMAN_GO.md(本書)
...
- migrations/・package.json・package-lock.json・.github/workflows/・UI・Electron・API routes・fixtures・他のharness・既存P6-A0/P6-I5/P6-FIX-001/002文書・docs/legacy/ALPHA_EVIDENCE_LEDGER.md・docs/archive/v0/GRAPH_MODEL.mdを変更しない。
