...
- `docs/legacy/P6_I5O_EXPLICIT_HUMAN_GO.md` — durable human Go record, created before any code.
- `docs/legacy/P6_I5O_TEST_ONLY_RECORDER_AUDIT_SUMMARY_HARNESS.md` — this document.
