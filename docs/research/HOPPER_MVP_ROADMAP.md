# Hopper MVP Roadmap (Archived)

> **Status:** Historical product roadmap / research only. This document is not the current implementation scope, release plan, or canonical UI specification.
>
> **Current source of truth:** [README.md](../../README.md), [Canonical Decision Index](../CANONICAL_DECISION_INDEX.md), and [Atra Doctrine](../ATRA_DOCTRINE.md).

This archive preserves prior Hopper/MVP assumptions without allowing them to imply that real LLM, n8n, X, RSS, browser-extension, or external-provider capabilities are implemented or authorized.
