...
Status: RESEARCH — unresolved frozen-V0 product hypotheses. Not Product Authority.
Scope: Historical V0 product doctrine, user pain, incentive, and objection hypotheses for Atra / WorkUnit OS

Current product direction, market, ICP, buyer, wedge, and form remain unresolved under
[`PRODUCT_STATE.md`](../../PRODUCT_STATE.md). Nothing below selects the next Atra product.
