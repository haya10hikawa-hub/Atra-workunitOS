...
Status: CURRENT DOCUMENTATION AUTHORITY

- [`PRODUCT_STATE.md`](../../PRODUCT_STATE.md) is the only product-state authority.
- One normative technical concept has one current owner.
- Technical truth does not imply product direction.
...
- Unresolved decisions remain explicit; point-in-time audits do not become permanent truth.
