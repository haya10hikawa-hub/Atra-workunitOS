 ...
 * anchored to that initialized session's manifest. Repository identity always comes
 * from the private allowlisted read-only Git implementation; no override is exposed.
 */
