...
import { toControlDirectory } from "./controlDirectoryAdapter.ts"
 ...
 */
export function composeSessionDependencies(runtime: ValidatedRequestRuntimeConfig): SessionDependencies {
  ...
  return {
    ...
    controlDirectory: control.ok ? toControlDirectory(control.bundle) : null,
...
export async function requireSession(
  ...
  try {
    dependencies = composeSessionDependencies(rt)
  } catch {
